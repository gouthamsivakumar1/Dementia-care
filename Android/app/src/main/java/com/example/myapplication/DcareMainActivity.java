...
public class DcareMainActivity extends Activity {
    public EditText usr;
    String TAG="Dcare";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dcaremain);
        ...
        call.enqueue(new Callback<List<RestLoginResponse>>() {
            ...
            public void onResponse(Call<List<RestLoginResponse>> call, Response<List<RestLoginResponse>> response) {
                ...
                if (pId.equalsIgnoreCase("unknown") == false) {
                    ...
                    Toast.makeText(DcareMainActivity.this, "Invalid Username or Password", Toast.LENGTH_SHORT).show();
                    FallNotification fallNotification = new FallNotification();
                    fallNotification.notify(DcareMainActivity.this, "example string", 0);
                }
            ...
            public void onFailure(Call<List<RestLoginResponse>> call, Throwable t) {
                ...
                Log.i(TAG, "Rest fail..");
                Toast.makeText(DcareMainActivity.this, "Failed to connect to server..", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
