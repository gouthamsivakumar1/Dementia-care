...
import com.example.myapplication.RestFetcher;
...
public class patientHealth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        i.putExtra(RestFetcher.EXTRA_PARAM1, "all");
        i.putExtra(RestFetcher.EXTRA_PARAM2, "bar");
        // Start the service
        startService(i);
    ...
    private BroadcastReceiver testReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                patientHealth_view.setText(resultValue + patientHealth_view.getText());
